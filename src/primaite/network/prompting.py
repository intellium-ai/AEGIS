...
Here is a statement to describe the action that needs to be made:
...
REASON_ACTION_SPACE_NODE_SELECT_TEMPLATE = """
This is the initial configuration of the network:
{network_description}
...
If choosing to take an action, you must select a node by name from the following list: {node_list}.
